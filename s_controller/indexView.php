...
if (isset($_SESSION['userId'])){
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($_POST['namaTxt']) || empty($_POST['passTxt'])){
            ...
            include_once 's_controller/database/connection.php';
            $nama = $_POST['namaTxt'];
            $pas = $_POST['passTxt'];
            $cekData = mysql_query("SELECT * FROM staf WHERE nama = '$nama' AND password = '$pas'");
            ...
            <form class="form-horizontal" action="" method="post">
                <fieldset>
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input class="form-control" placeholder="Username" name="namaTxt" type="text" value="DIT">
                    </div>
                    <div class="clearfix"></div><br>

                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
                        <input class="form-control" placeholder="Password" name="passTxt" type="password" value="" autofocus="">
                    </div>
